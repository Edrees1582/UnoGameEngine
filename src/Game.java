    ...
    public void play() {
        ...
        while (gameData.gameRules.checkGameWinner() == -1) {
            while (gameData.gameRules.checkRoundWinner() == -1) {
                ...
                System.out.println("Player[" + gameData.currentPlayer.getIndex() + "]'s turn:");
                ...
                for (int i = 0; i < gameData.players.size(); i++) {
                    if (i != gameData.turn.value) {
                        System.out.println("Number of cards in Player[" + i + "]'s hand: " + gameData.players.get(i).getHandSize());
                    }
                }
        ...
        System.out.println("Player[" + gameData.players.get(gameData.gameRules.checkGameWinner()).getIndex() + "] is the WINNER!!!!!");
    }
